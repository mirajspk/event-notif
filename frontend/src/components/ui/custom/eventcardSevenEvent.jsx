    ...
    const fetchEvents = async () => {
      try {
        ...
        const filteredEvents = response.data.filter(event => {
          ...
          return eventDate >= today && eventDate <= sevenDaysFromNow && event.type === "event"; // Check if the event is within the next 7 days
        });
...
export default eventcardSevenEvent;
